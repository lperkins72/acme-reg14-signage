...
```text
?tenant=acme&region=reg14&device=nuc-001
```

Example:

```text
https://<deployment-domain>/?tenant=acme&region=reg14&device=nuc-001
```
...
5. test one launcher such as `/devices/reg14/nuc-001.html`
