...
This folder is the region-default content layer for `reg14`.
...
- `regions/reg14/data/primary-assets.json`
- `regions/reg14/data/primary.json`
- `regions/reg14/data/footer.json`
- `regions/reg14/data/primaryending.json`
- `regions/reg14/assets/primary/manifest.json`
- `regions/reg14/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg14`.
